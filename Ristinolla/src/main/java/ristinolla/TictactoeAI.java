...
public class TictactoeAI {
    ...
    public boolean getplayesx() {
        return this.playsx;
    }
    
    public void setplayesx(boolean playsx) {
        this.playsx = playsx;
    }
    ...
    */
    ...
    public int check() {
        ...
        for (int i = 1; i < 4; i++) {
            int winner = checkcolumn(board, i);
    ...
    public int checkcolumn(String board, int column) {
        int xs = 0;
        int os = 0;
    ...
    public int checkdiagonals(String board) {
